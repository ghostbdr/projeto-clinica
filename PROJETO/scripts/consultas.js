...
const dados2 = JSON.parse(localStorage.getItem("cadastro"));
    ...
    /*
        ...
        PRA RESOLVER O PROBLEMA DOS LISTENERS ESCUTAREM UM BOTAO QUE N TA MAIS NA TELA

        VAMOS CRIAR AS DIV NA PAGINA MAS VAMOS MEXER SO COM O HIDDEN OU O DISPLAY NONE DELAS, O BOTAO OCULTA AS OUTRAS, CASO PRECISE DA PARA REMOVER OS LISTENERS COM A MESTA FUNÇÃO DE EXIBIÇÃO
    */
